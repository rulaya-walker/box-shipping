...
const Musica = ({ getQuantity, updateQuantity, setShowAddBoxForm, onItemIdsChange }) => {
  const dispatch = useDispatch();
  const { productsByCategory, loading, error } = useSelector((state) => state.products);

  useEffect(() => {
    dispatch(fetchProductsByCategory('Musical Instruments'));
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    if (onItemIdsChange) {
      onItemIdsChange('musical', itemIds);
    }
    ...
    return (
      <div>
        ...
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => dispatch(fetchProductsByCategory('Musical Instruments'))}
    ...
    <div>
      ...
      <div className="space-y-4">
        {productsByCategory && productsByCategory.length > 0 ? (
          ...
          <div className="text-center py-8">
            <p className="text-gray-600">No musical instrument products available at the moment.</p>
          </div>
        )}

        {/* Add custom musical option */}
        <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h4 className="font-semibold mb-2">Add musical instruments</h4>
              <p className="text-gray-600 text-sm mb-4">
                Please add the dimensions of your musical instruments here.
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center">
