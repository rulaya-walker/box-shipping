...
const Office = ({ getQuantity, updateQuantity, setShowAddBoxForm, onItemIdsChange }) => {
  const dispatch = useDispatch();
  const { productsByCategory, loading, error } = useSelector((state) => state.products);

  useEffect(() => {
    dispatch(fetchProductsByCategory('Office'));
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    if (onItemIdsChange) {
      onItemIdsChange('office', itemIds);
    }
    ...
    return (
      <div>
        ...
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => dispatch(fetchProductsByCategory('Office'))}
    ...
    <div>
      ...
      <div className="space-y-4">
        {productsByCategory && productsByCategory.length > 0 ? (
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      {product.details || 'Professional packaging solution for office equipment.'}
                    </p>
          ...
          <div className="text-center py-8">
            <p className="text-gray-600">No office products available at the moment.</p>
          </div>
        )}

        {/* Add custom office option */}
        <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h4 className="font-semibold mb-2">Add office items</h4>
              <p className="text-gray-600 text-sm mb-4">
                Please add the dimensions of your office items here.
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center">
