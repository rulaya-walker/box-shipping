...
const LivingRoom = ({ getQuantity, updateQuantity, setShowAddBoxForm, onItemIdsChange }) => {
  ...
  useEffect(() => {
    dispatch(fetchProductsByCategory('Living Room'));
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    if (onItemIdsChange) {
      onItemIdsChange('living_room', itemIds);
    }
    ...
    return (
      <div>
        ...
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => dispatch(fetchProductsByCategory('Living Room'))}
    ...
    <div>
      ...
      <div className="space-y-4">
        {productsByCategory && productsByCategory.length > 0 ? (
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      {product.details || 'Professional packaging solution for living room furniture.'}
                    </p>
          ...
          <div className="text-center py-8">
            <p className="text-gray-600">No living room products available at the moment.</p>
          </div>
        )}

        {/* Add custom living room option */}
        <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h4 className="font-semibold mb-2">Add living room items</h4>
              <p className="text-gray-600 text-sm mb-4">
                Please add the dimensions of your living room items here.
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center">
