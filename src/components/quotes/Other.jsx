...
const Other = ({ getQuantity, updateQuantity, setShowAddBoxForm, onItemIdsChange,toCountry }) => {
  const dispatch = useDispatch();
  const { productsByCategory, loading, error } = useSelector((state) => state.products);

  useEffect(() => {
    dispatch(fetchProductsByCategory('Other'));
  }, [dispatch]);
    ...
    return (
      <div>
        ...
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => dispatch(fetchProductsByCategory('Other'))}
      ...
      <div className="space-y-4">
        ...
        <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h4 className="font-semibold mb-2">Add other items</h4>
              <p className="text-gray-600 text-sm mb-4">
                Please add the dimensions of your other items here.
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center">
