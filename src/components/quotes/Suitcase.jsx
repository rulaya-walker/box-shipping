...
const Suitcase = ({ getQuantity, updateQuantity, setShowAddBoxForm, onItemIdsChange,toCountry }) => {
  ...
  if (loading) {
    return (
      <div>
        <h3 className="text-xl font-semibold mb-4">Suitcase & Luggage</h3>
    ...
    return (
      <div>
        ...
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => dispatch(fetchProductsByCategory('Suitcase'))}
    ...
    <div>
      ...
      <div className="space-y-4">
        {productsByCategory && productsByCategory.length > 0 ? (
                ...
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-600">Suitcase</div>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold mb-2">{product.name}</h4>
                    <p className="text-gray-600 text-sm mb-4">
                      {product.details || 'Professional packaging solution for suitcases and luggage.'}
                    </p>
          ...
          <div className="text-center py-8">
            <p className="text-gray-600">No suitcase packaging available at the moment.</p>
          </div>
        )}
        ...
        {/* <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h4 className="font-semibold mb-2">Add suitcase</h4>
              <p className="text-gray-600 text-sm mb-4">
                Please add the dimensions of your suitcases here.
              </p>
            </div>
            <div className="flex items-center">
              <div className="flex items-center">
